 ...
 */
class Document extends \projectBundle\Entity\Document implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'projectBundle\\Entity\\Document' . "\0" . 'id', 'file', '' . "\0" . 'projectBundle\\Entity\\Document' . "\0" . 'name', '' . "\0" . 'projectBundle\\Entity\\Document' . "\0" . 'path');
        }
