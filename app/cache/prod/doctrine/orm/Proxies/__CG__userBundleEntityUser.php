...
class User extends \userBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'userBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'userBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'userBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'userBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'userBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'userBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'userBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'userBundle\\Entity\\User' . "\0" . 'email');
        }
