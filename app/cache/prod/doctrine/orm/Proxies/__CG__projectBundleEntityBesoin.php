 ...
 */
class Besoin extends \projectBundle\Entity\Besoin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'projectBundle\\Entity\\Besoin' . "\0" . 'id', '' . "\0" . 'projectBundle\\Entity\\Besoin' . "\0" . 'projet', '' . "\0" . 'projectBundle\\Entity\\Besoin' . "\0" . 'version', '' . "\0" . 'projectBundle\\Entity\\Besoin' . "\0" . 'nom');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Besoin $proxy) {
