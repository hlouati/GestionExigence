 ...
 */
class VersionExigence extends \projectBundle\Entity\VersionExigence implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'id', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'numVersion', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'nom', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'descp', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'exigence', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'redact', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'date', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'curent', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'perio', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'type', '' . "\0" . 'projectBundle\\Entity\\VersionExigence' . "\0" . 'def');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VersionExigence $proxy) {
    ...
    public function setPerio($perio)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPerio', array($perio));

        return parent::setPerio($perio);
    }
    ...
    public function getPerio()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPerio', array());

        return parent::getPerio();
    }
